...
from util.dataset import DatasetInit
from util.utils import (load_checkpoint, save_checkpoint, basic_transform, train_transform, get_loaders, train_fn,
...
IMG_DIR = "../data/images"  # train image directory
MASK_DIR = "../data/masks"  # train mask directory
...
MODEL_NAME = "PC_HIINet"  # name of model

# Import model
from model.PC_HIINet import PC_HIINet

# Define model
MODEL = PC_HIINet().to(DEVICE)
